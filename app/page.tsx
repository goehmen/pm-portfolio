          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600">
                  Agentic Systems • Computer Vision • Neuro-Probabilistic Decision Engines
                </p>
              </div>
        ...
        <section id="projects" className="py-20 px-4 bg-gray-50 dark:bg-gray-900">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
              ...
              {/* Project Card 2 - Fractional CPO (moved from upper-left, demoted) */}
              ...
              {/* Project Card 3 - Platform Metrics Dashboard (unchanged) */}
              ...
              {/* Project Card 4 - API Documentation Hub (unchanged) */}
              <div className="bg-white dark:bg-gray-800 dark:hover:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:shadow-lg dark:hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all duration-200">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">
